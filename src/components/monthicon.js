            ...
            {(() => {
                if (month == 1) {
                  ...
                  return (
                    ...
                    return (
                      <div><img src="jun_month.png" alt="smiling daisy" height="100px" /></div>
                    ) 
                } else if (month === 8) {
                    return (
                      <div><img src= "storm.svg" alt="smiling daisy"/></div>
                    ) 
                } else if (month === 9) {
                    return (
                      <div><img src= "storm.svg" alt="storm cloud"/></div>
                    ...
                    return (
                      <div><img src= "month_dec.png" alt="gingerbread man" height="100px"/></div>
                    )   
                } else {
                  return (
                    <div></div>
